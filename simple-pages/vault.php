		...
		<!--Top 3 Rows-->
		  <div class="col-xs-9 col-xs-offset-2 col-md-4  col-md-offset-0 col-sm-6 col-sm-offset-0 col-lg-4 col-lg-offset-0">
            <div class="card card-block">
              <a href="/items/browse?tags=Directive&view=grid"><img class="img-circle img-responsive img-center" alt="" src="<?php echo img('directives.JPG', 'assets/img/vault');?>">
          ...
          <div class="col-xs-9 col-xs-offset-2 col-md-4  col-md-offset-0 col-sm-6 col-sm-offset-0 col-lg-4 col-lg-offset-0">
            <div class="card card-block">
              <a href="/items/browse?tags=Maps&view=grid"><img class="img-circle img-responsive img-center" alt="" src="<?php echo img('maps.JPG', 'assets/img/vault');?>">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    Maps
